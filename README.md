...
**Address:** Atlanta, GA
**Email:** [estaton@emory.edu](mailto:estaton@emory.edu) / [ec.mitchell3@gmail.com](mailto:ec.mitchell3@gmail.com)
...
Contains model input parameters used throughout the GEM microsimulation framework.
...
1. Users can download and use different years of population and epidemiological data to model different years. It is recommended to use the same file naming conventions and specify the `*_data_yr` variables in the config function.
...
Additional standard library modules used include:
